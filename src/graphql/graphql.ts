...
export type ContentsQuery = { contents: Array<{ id: string, public_from?: any | null, public_till?: any | null, labels?: Array<{ label?: { name?: string | null, id: string } | null } | null> | null, translations?: Array<{ name: string, slug?: string | null, perex?: string | null, date_created?: any | null, language?: { code: string } | null, image?: { id: string, folder?: string | null, filename_disk?: string | null, width?: number | null, height?: number | null } | null } | null> | null, web?: { shortcut?: string | null } | null }> };
